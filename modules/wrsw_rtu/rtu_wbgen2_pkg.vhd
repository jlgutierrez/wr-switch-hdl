...
package rtu_wbgen2_pkg is
  ...
  constant c_rtu_in_registers_init_value: t_rtu_in_registers := (
    ...
    type t_rtu_out_registers is record
      ...
      rx_hp_ctr_prio_mask_o                    : std_logic_vector(7 downto 0);
      rx_hp_ctr_at_fmatch_too_slow_o           : std_logic;
      ...
      rx_llf_ff_mask_o                         : std_logic_vector(31 downto 0);
    ...
    constant c_rtu_out_registers_init_value: t_rtu_out_registers := (
      ...
      rx_hp_ctr_prio_mask_o => (others => '0'),
      rx_hp_ctr_at_fmatch_too_slow_o => '0',
