...
package tru_wbgen2_pkg is
  ...
  constant c_tru_in_registers_init_value: t_tru_in_registers := (
    ...
    type t_tru_out_registers is record
      ...
      lacr_agg_gr_num_o                        : std_logic_vector(3 downto 0);
      lacr_agg_df_br_id_o                      : std_logic_vector(3 downto 0);
      lacr_agg_df_un_id_o                      : std_logic_vector(3 downto 0);
      lagt_lagt_gr_id_mask_0_o                 : std_logic_vector(3 downto 0);
      lagt_lagt_gr_id_mask_1_o                 : std_logic_vector(3 downto 0);
      lagt_lagt_gr_id_mask_2_o                 : std_logic_vector(3 downto 0);
      lagt_lagt_gr_id_mask_3_o                 : std_logic_vector(3 downto 0);
      lagt_lagt_gr_id_mask_4_o                 : std_logic_vector(3 downto 0);
      lagt_lagt_gr_id_mask_5_o                 : std_logic_vector(3 downto 0);
      lagt_lagt_gr_id_mask_6_o                 : std_logic_vector(3 downto 0);
      lagt_lagt_gr_id_mask_7_o                 : std_logic_vector(3 downto 0);
    ...
    constant c_tru_out_registers_init_value: t_tru_out_registers := (
      ...
      lacr_agg_gr_num_o => (others => '0'),
      lacr_agg_df_br_id_o => (others => '0'),
      lacr_agg_df_un_id_o => (others => '0'),
      lagt_lagt_gr_id_mask_0_o => (others => '0'),
      lagt_lagt_gr_id_mask_1_o => (others => '0'),
      lagt_lagt_gr_id_mask_2_o => (others => '0'),
      lagt_lagt_gr_id_mask_3_o => (others => '0'),
      lagt_lagt_gr_id_mask_4_o => (others => '0'),
      lagt_lagt_gr_id_mask_5_o => (others => '0'),
      lagt_lagt_gr_id_mask_6_o => (others => '0'),
      lagt_lagt_gr_id_mask_7_o => (others => '0'),
      tcgr_trans_ena_o => '0',
